...
/**
 * Servlet implementation class ShowRemima
 */
@WebServlet("/showremima")
public class ShowRemima extends HttpServlet {
	/**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user!=null && isLogin.equals("1")) {	
			request.getRequestDispatcher("remima.jsp").forward(request, response);
		}else {

...
<%@ include file="menu.jsp" %>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><a class="crumb-name" href="/shop/adminjsp/admin_douserselect">用户管理</a>
            <span class="crumb-step">&gt;</span><span>修改用户</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shop/adminjsp/admin_douserupdate" method="post" id="myform" name="myform">

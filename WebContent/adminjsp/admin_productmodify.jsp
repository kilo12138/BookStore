    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shop/adminjsp/admin_doproductupdate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                        	<tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="productname" size="50" type="text" value="${p.PRODUCT_NAME }">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="price" size="50" type="text" value="${p.PRODUCT_PRICE }">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>图书库存：</th>
                                <td>
                                    <input class="common-text required" id="title" name="num" size="50" type="text" value="${p.PRODUCT_STOCK }">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>图书介绍：</th>
                                <td>
                                    <input class="common-text required" id="title" name="dest" size="50" type="text" value="${p.PRODUCT_DESCRIPTION }">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
